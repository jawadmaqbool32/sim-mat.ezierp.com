...
class User extends Authenticatable
{
        ...
        return DataTables::of($users)
            ...
            ->editColumn('image', function ($user) {
                ...
                <div class="symbol symbol-45px me-5">
                    <img alt="thumbnail" src="' . asset("assets/media/users/profile/" . $user->image) . '">
                </div>
            </div>';
            })
            ...
            ->addColumn('action', function ($user) {
                ...
                if (auth()->user()->hasPermission('edit user')) {
                    $btns[] = '<a href="' . route('employees.edit', $user->uid) . '"  class="mx-1 float-end btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
    ...
    public function scopeEmployeeTable($query)
    {
        $users = $query->with('role');
        return DataTables::of($users)
            ->addIndexColumn()
    ...
    {
        return $this->hasOne(
            EmployeePersonalInformation::class,
            'employee_id',
            'id',
            'order_id',
        );
