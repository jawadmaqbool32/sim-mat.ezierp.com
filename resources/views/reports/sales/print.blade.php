                ...
                <table class="table border-bottom border-1 border-dark" style="min-height: 500px !important">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="p-2 border-dark border border-1 fw-bold">Order#</th>
                            <th class="p-2 border-dark border border-1 fw-bold">Amount</th>
                            <th class="p-2 border-dark border border-1 fw-bold">Date</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td class="p-2 border-dark border border-1">{{ $order->order_no }}</td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="p-2 border-dark border border-1 text-end fw-bold" colspan="3">
                                {{ $amount }}</th>
                        </tr>
                    </tfoot>
                </table>
