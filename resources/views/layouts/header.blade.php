        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                    data-kt-menu-placement="bottom-end">
                    <img src="{{ auth()->user()->image? asset('assets/media/users/profile/'.auth()->user()->image): asset('assets/media/avatars/300-1.jpg') }}" alt="user" />
                </div>
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="{{ auth()->user()->image? asset('assets/media/users/profile/'.auth()->user()->image): asset('assets/media/avatars/300-1.jpg') }}" />
                            </div>
                            <div class="d-flex flex-column">
                    ...
                    <div class="menu-item px-5">
                        <form id="" action="{{ route('logout') }}" method="post">@csrf
                            <button class="menu-link px-5 px-5 w-100 border-0" type="submit">
                                Sign out
                            </button>
                        </form>
                    </div>
